...
#'
#' Method \code{compare_pred.saeTrafo} compares predictions of two saeTrafo objects.
#'
#' @param object1 an object of type "saeTrafo".
#' @param object2 an object of type "saeTrafo" or "emdi".
#' @param MSE if \code{TRUE}, MSE estimates are returned. Defaults to
...
#' \(if \code{MSE} is set to \code{TRUE}\) of both objects. If column names are duplicated,
#' the suffixes "_1" and "_2" are added to their names. "_1" and "_2" standing
#' for object1 and object2, respectively.
...
compare_pred.saeTrafo <- function(object1, object2, MSE = FALSE, ...) {
  ...
  if (!inherits(object1, "saeTrafo") || !(inherits(object2, "emdi") | inherits(object2, "saeTrafo"))) {
    stop('Object 1 must be of class saeTrafo object 2 of class saeTrafo or emdi.')
  }
